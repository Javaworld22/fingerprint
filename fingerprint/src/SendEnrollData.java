 ...
 * @author Abc
 */
public class SendEnrollData implements HttpHandler{
    private String finger = "";
     ...
     @Override
         ...
         public void handle(HttpExchange he) throws IOException {
                 // parse request\
                 if(EnrollPanel.finger != null)
                     finger = EnrollPanel.finger;
                 else
                     finger = "";
                ...
                he.getResponseHeaders().add("Access-Control-Allow-Credentials-Header", "*");
                 String json = new ParameterStringBuilder().toJsonw(EnrollPanel.id, finger);
